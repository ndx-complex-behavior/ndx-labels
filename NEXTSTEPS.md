...
# Next Steps for ndx-labels Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-labels directory.
...
`spec/ndx-labels.namespace.yaml` and
`spec/ndx-labels.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-labels
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/akshay-jaggi/ndx-labels/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-labels/0.1.0
...
`staged-extensions/ndx-labels`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-labels
    ```

13. Edit `staged-extensions/ndx-labels/ndx-meta.yaml`
...
name: ndx-labels
version: 0.1.0
src: https://github.com/akshay-jaggi/ndx-labels
pip: https://pypi.org/project/ndx-labels/
license: BSD 3-Clause
maintainers: 
  - akshay-jaggi
```

14. Edit `staged-extensions/ndx-labels/README.md`
to add information about your extension. You may copy it from
`ndx-labels/README.md`.

```bash
cp ndx-labels/README.md staged-extensions/ndx-labels/README.md
```
...
git add ndx-labels
git commit -m "Add new catalog entry for ndx-labels" .
git push
```
...
ndx-labels-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-labels GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-labels-feedstock repository on GitHub.
